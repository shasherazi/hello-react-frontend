...
Testing React on Rails (single application). [Backend link](https://github.com/shasherazi/hello-rails-backend)
...
```sh
  git clone git@github.com:shasherazi/hello-react-frontend.git
